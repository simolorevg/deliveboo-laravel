        ...
        <div class="container-create-restaurant">
            ...
            <div class="mx-5">
                ...
                <form class="d-flex flex-column form" action="{{ route('admin.restaurants.store') }}" method="POST"
                    ...
                    <label class="info my-2 @error('city') is-invalid @enderror" for="city">Città:  <span class="need">*</span></label>
                    ...
                    <label class="info my-2 @error('address') is-invalid @enderror" for="address">Indirizzo:  <span class="need">*</span></label>
                    ...
                    <label class="info my-2 @error('phone') is-invalid @enderror" for="phone">Telefono:  <span class="need">*</span></label>
                    ...
                    @enderror
                    <label class="info my-2 @error('vat_number') is-invalid @enderror" for="vat_number">P.IVA :  <span class="need">*</span></label>
